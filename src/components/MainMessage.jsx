...
import { getMainMessage } from "../services";

export default function MainMessage() {

  function MessageCardId(props) {
  ...
  function ShowCard() {
   ...
   return (
    ...
    const { data, loading, error } = useQuery(getMainMessage);
 ...
 return(
  <div className="main-list">
              {data.messages.map((message) => {
                return (<MessageCardId key={message.id} {...message}/>)
              })}
