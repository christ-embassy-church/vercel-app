...
import { getCategoryCroissanceDeglise } from "../services";

export default function CroissanceDeglise() {

  function CroissanceDegliseCard(props) {
  ...
  function ShowCard() {
   ...
   return (
    ...
    const { data, loading, error } = useQuery(getCategoryCroissanceDeglise);
 ...
 return(
  <div>
    <div className="category--page">
            <h1 className="recent--title">Catégorie : Croissance d'église</h1>
        </div>
    <div className="alls-list">
                {data.messages.map((message) => {
                  return <CroissanceDegliseCard key={message.id} {...message}/>
                })}
