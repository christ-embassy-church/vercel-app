...
import { getCategoryEvangelisation } from "../services";

export default function Evangelisation() {

  function EvangelisationCard(props) {
  ...
  function ShowCard() {
   ...
   return (
    ...
    const { data, loading, error } = useQuery(getCategoryEvangelisation);
 ...
 return(
  <div>
    <div className="category--page">
            <h1 className="recent--title">Catégorie : Evangélisation</h1>
        </div>
    <div className="alls-list">
                {data.messages.map((message) => {
                  return <EvangelisationCard key={message.id} {...message}/>
                })}
