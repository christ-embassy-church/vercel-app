...
import { getCategoryFoi } from "../services";

export default function Foi() {

  function FoiCard(props) {
  ...
  function ShowCard() {
   ...
   return (
    ...
    const { data, loading, error } = useQuery(getCategoryFoi);
 ...
 return(
  ...
  <div>
    <div className="category--page">
            <h1 className="recent--title">Catégorie : Foi</h1>
        </div>
    <div className="alls-list">
                {data.messages.map((message) => {
                  return <FoiCard key={message.id} {...message}/>
                })}
